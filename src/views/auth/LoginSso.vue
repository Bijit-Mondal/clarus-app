      ...
      <div class="flex flex-col gap-6">
        <div class="flex items-start">
          ...
          <div class="flex flex-col gap-2 w-full">
            ...
            <p class="text-muted-foreground text-center">Enter your work email to continue with SSO</p>
          </div>
        </div>
        <div class="grid gap-4">
          <Button class="w-full flex items-center justify-center gap-2 border border-border bg-card text-card-foreground hover:bg-accent hover:text-accent-foreground dark:border-border dark:bg-card dark:text-card-foreground dark:hover:bg-accent dark:hover:text-accent-foreground" type="button">
          ...
          <Button class="w-full" type="submit" @click="handleSubmit">
            Continue with SSO
          </Button>
        </div>
